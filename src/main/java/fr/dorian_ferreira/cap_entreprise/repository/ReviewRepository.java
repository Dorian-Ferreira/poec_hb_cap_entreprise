        ...
        extends JpaRepository<Review, Long>
{
    ...
    Page<Review> findAllByModeratorNotNullAndGameNameContainingIgnoreCaseOrPlayerUsernameContainingIgnoreCase(String search1, String search2, String search3, Pageable pageable);
